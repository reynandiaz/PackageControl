...
using PackageService.ServiceProcess;
...
namespace PackageService
{
    ...
    public class Service1 : System.Web.Services.WebService
    {
        ...
        [WebMethod]
        public UploadScannedResult UploadScannedData(List<UploadScannedTableRow> scannedBarcodes)
        {
            using (var connection = new SqlConnection(Properties.Settings.Default.ConnectionString))
            {
                ...
                try
                {
                    ...
                    foreach (UploadScannedTableRow row in scannedBarcodes)
                    {
                        result.ServerStatus = 1;
                        UploadScannedbyRow.TransmitScannedData(row,transaction,connection);
    ...
    public class UploadScannedResult
    {
        ...
        {
            this.UploadedData = new List<UploadScannedTableRow>();
        }
        public int ServerStatus { get; set; } // [0]: Success, [1 or later]: Failure
        public string ServerMessage { get; set; }
        public List<UploadScannedTableRow> UploadedData { get; set; }
    }
}
